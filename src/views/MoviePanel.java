...
public class MoviePanel extends JPanel {
	...
	public void updatePanel(ArrayList<Movie> movies, JPanel contentPane) {
        ...
        for (Movie obj : movies) {
            String[] row = {Integer.toString(obj.getId()),obj.getTitle(), obj.getCountry(), Integer.toString(obj.getDurationTime()) + "phut", Integer.toString(obj.getPrice())+ "VND"};
            model.addRow(row);
        }
...
//        genderColumn.setCellEditor(new DefaultCellEditor(genderComboBox));
        ...
        JScrollPane scrollPane = new JScrollPane(movieTable, JScrollPane.VERTICAL_SCROLLBAR_ALWAYS, JScrollPane.HORIZONTAL_SCROLLBAR_ALWAYS);
