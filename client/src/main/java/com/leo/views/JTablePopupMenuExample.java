...
public class JTablePopupMenuExample extends JFrame implements ActionListener {
  ...
  public JTablePopupMenuExample(JTable table, DefaultTableModel tableModel) {
    this.table = table;
    this.tableModel = tableModel;

    // // sample table data
    // String[] columnNames = new String[] {"Title", "Author", "Publisher",
    // "Published Date", "Pages", "Rating"};
    // String[][] rowData = new String[][] {
    // {"Effective Java", "Joshua Bloch", "Addision-Wesley", "May 08th 2008", "346",
    // "5"},
    // {"Thinking in Java", "Bruce Eckel", "Prentice Hall", "Feb 26th 2006", "1150",
    // "4"},
    // {"Head First Java", "Kathy Sierra & Bert Bates", "O'Reilly Media", "Feb 09th
    // 2005", "688", "4.5"},
    // };
